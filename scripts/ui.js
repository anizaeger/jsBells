...
/** ------------------------------------------------------------------------- *
 * FUNCTION:      setBtn
 * DESCRIPTION:   Calculate size of bell button by determining the size of
 *                the screen, determining the lesser dimension, and setting
 *                the button size to a square of one half that amount.
 * RETURNS:       Nothing (Void Function)
 * -------------------------------------------------------------------------- */
function setBtn() {
